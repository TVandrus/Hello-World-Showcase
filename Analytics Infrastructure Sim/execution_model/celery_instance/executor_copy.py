...
from celery_instance.config_copy import DEFAULT_CONFIG, dict_wrapper
from celery_instance.dagster_celery_config import broker_url, result_backend
...
class CeleryExecutor(Executor):
    ...
    def execute(self, plan_context, execution_plan):
        from celery_instance.core_execution_loop_copy import core_celery_execution_loop
